# Makefile for NSFC Proposal Template
# 
...
# Generate nsfc.ins from nsfc.dtx (internal section)
# The internal section is executed when compiling nsfc.dtx with latex
$(NAME).ins: $(NAME).dtx
...
help:
	@echo "NSFC Proposal Template Makefile"
	@echo ""
