%% -*- mode: TeX -*-
%% -*- coding: utf-8 -*-
\documentclass[UTF8,zihao=-4, fontset=macnew]{ctexart} %%for macOS set: fontset=macnew
%% ==模式切换 =====
\usepackage[draft]{mnsfc} %%draft is default, final is for the final version
...
\mnsfcResearchField{调和映照}  %% 主要研究领域（可选，默认为空）
%% 选择研究属性（二选一）：
