...
%% ==模式切换 =====
\usepackage[final]{nsfc} %%draft is default, final is for the final version
...
%% 选择研究属性（二选一）：
%% \nsfcResearchTypeFree  %% 自由探索类基础研究
%% \nsfcResearchTypeTarget %% 目标导向类基础研究
%% 或者使用自定义文本：
%% \nsfcResearchType{自由探索类基础研究}
%% \nsfcResearchType{目标导向类基础研究}
\nsfcResearchTypeFree  %% 示例：选择自由探索类基础研究
